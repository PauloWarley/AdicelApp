                    ...
                    if (response.status == 200)
                    {
                        ...
                        for (const i in listItens){
                            ...
                            pdMedidas.push({
                                ...
                                Medida : [listItens[i].Altura,listItens[i].Largura,listItens[i].Profundidade].sort(function(a, b) {
                                    return a - b;
                                    }),
                                ...
                                if (response.status == 200)
                                {
                                    ...
                                    for (var i in resp){
                                        ...
                                        cxMedidas.push({
                                            ...
                                            Medida : [resp[i].Altura,resp[i].Largura,resp[i].Profundidade].sort(function(a, b) {
                                                return a - b;
                                                })
                                        }
                                        )
